<?php 
	...
	$sql = "SELECT * FROM port WHERE id = {$pId} ";
...
<div class="row">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form class="row g-3" method="POST" enctype="multipart/form-data">
				  ...
				  <div class="col-md-6">
				    <label for="image" class="form-label">Select Web Picture</label>
				    <input type="file" class="form-control form-control-lg" name="image">
				  </div>

				  <div class="col-md-6">
				    <label for="image" class="form-label">Select Card Picture</label>
				    <input type="file" class="form-control form-control-lg" name="image">
				  </div>
				  ...
				  <div class="col-lg-6">
				    ...
				    <select class="form-control form-control-lg" name="status">
				  	...
				  	<div>
				  		<br><br>
				  		<button type="submit" class="btn btn-lg btn-primary" name="editPort">Save Changes</button>
	...
	<div class="col-lg-4">
			<div class="card">
				<div class="card-body">
					<img src="../img/port/<?= $image; ?>" width="100%">
				</div>
			</div>
		</div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	<form method="POST">
        	...
        	<button name="deletePort" type="submit" class="btn btn-danger">Yes</button>
      	</form>
