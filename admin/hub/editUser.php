<?php 
	...
	$sql = "SELECT * FROM portusers WHERE id = {$userId}";
...
</div> <!-- col-lg-8closing div -->
	</div>
	<div class="col-lg-4">
		<div class="card">
			<div class="card-body">
				<img class="img img-thumbnail" src="../img/portuser/<?= $image; ?>" width="100%">
			</div>
		</div>
...
<?php 
	...
	if (isset($_POST['deleteUser'])) {
		$sql = "DELETE FROM portusers  WHERE id = {$id} ";
